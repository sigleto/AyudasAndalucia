...
const InformeAyudasAgricultores: React.FC = () => {
  ...
  // Activar el botón del PDF cuando se gane la recompensa
  useEffect(() => {
    if (recompensaGanada) {
      setBotonActivo(true); // Habilitar el botón para descargar el PDF
    }
  }, [recompensaGanada]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.value}>{explotacion === 'S' ? 'Sí' : 'No'}</Text>

        <Text style={styles.label}>Plan empresarial viable:</Text>
        <Text style={styles.value}>{planEmpresarial === 'S' ? 'Sí' : 'No'}</Text>
